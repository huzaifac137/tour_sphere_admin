...
const OTPVerification = () => {
  ...
  const submitedData = async (e: any) => {
    e.preventDefault();
    ...
    try {
      ...
      const response = await axios.post(
        `${serverLink}api/v1/admin-ki-apis/otp/verify-and-reset`,
        {
          sentOtp: otp,
              ...
              <form onSubmit={submitedData}>
                ...
                <div className="mb-5">
                  <input
                    type="submit"
                    value="Submit"
                    className="w-full cursor-pointer rounded-lg border border-[#3e4532] bg-[#3e4532] p-4 text-white transition hover:bg-opacity-90"
                    // onClick={changeRoute}
                  />
                </div>
              </form>
