...
const EditTourDetails = () => {
  ...
  const user = async () => {
    try {
      const res = await axios.get(`${serverLink}api/v1/admin-ki-apis/requests/tours/for-edit/${editTourRequestId}` , {
        headers : {
      ...
      alert('Unable to Fetch edit tour request Details');
    }
  };
